...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>.  Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>.<br /><a href="http://www.picaflor-azul.com" target="_blank">Zen cart templates</a> by Picaflor Azul.');
...
// only for where multiple add to cart is used:
  ...
  define('TEXT_PRODUCT_WEIGHT_UNIT',' shipping unit(s)');

// Shipping
  define('TEXT_SHIPPING_WEIGHT',' shipping unit(s)');
