...
define('TEXT_INFORMATION', 'Shipping costs are based on your country and the volume (shipping units) of the products selected.  Because I use flat-rate shipping options, you can often times add more product without increasing the shipping cost.');
