...
// page title
define('TITLE', 'Board Game Storage');

// Site Tagline
define('SITE_TAGLINE', 'Colored baggies for board game storage');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'board games, colored baggies, zip-lock baggies, colored bags, zip-lock bags, settlers of catan');
